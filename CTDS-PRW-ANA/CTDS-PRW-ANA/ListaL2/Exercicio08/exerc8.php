...
<body> 
    ...
    //testando se o cliente comprou, no mínimo, um produto na loja
        ...
        //mensagem
            ...
            echo "<p>Caro Cliente, você não adquiriu nenhum produto de nossa farmácia. Portanto, o valor de sua compra é de <span>R$0,00</span>. <br>Obrigado pela preferência e volte sempre.</p>";
        }
    ?>
</body>
</html>